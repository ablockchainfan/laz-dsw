...
class Tgw(core.Construct):
    ...
    def _create_Tgw(self):
    #   //Create TG gateway
        self.TransitGateway =  ec2.CfnTransitGateway(scope=self,
                id=self.config['network']['tgw']['name'],
                description = self.config['network']['tgw']['description'],
